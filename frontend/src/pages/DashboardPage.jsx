...
const DashboardPage = () => {
  ...
  const getActivityIcon = (type) => {
    switch (type) {
      ...
      case "info":
        return <FontAwesomeIcon icon={faUsers} className="h-4 w-4 text-info" />;
      case "warning":
        return (
          <FontAwesomeIcon
  ...
  return (
    <div className="min-h-screen font-pretendard relative overflow-hidden">
      ...
      <div className="relative z-10 p-8 max-w-[1400px] mx-auto">
        ...
        <div className="mb-2">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="flex items-center space-x-1 px-2 py-1 mt-4 bg-white/20 border  border-gray-300/40 text-gray-300 rounded-xl hover:bg-blue-500/40 transition-colors text-sm font-medium"
            >
              <span>로그아웃</span>
            </button>
          </div>
        ...
        <Card
          title="기존 프로젝트"
          subtitle="생성된 프로젝트들을 확인하고 관리하세요"
          className="shadow-lg mb-10 bg-gray-100 border-0"
        >
              ...
              if (projects.length === 0) {
                return (
                  <div className="col-span-full text-center py-8 text-gray-500">
                    ...
                    <p className="text-sm">
                      위의 "프로젝트 만들기" 버튼을 클릭하여 첫 번째 프로젝트를
                      생성해보세요!
                    </p>
                  </div>
                );
